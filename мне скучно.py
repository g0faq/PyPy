...
# вычисление цвета
background_color = (random.randint(10, 255), random.randint(10, 255), random.randint(10, 255)) # цвет фона
text_colors = (random.randint(10, 255), random.randint(10, 255), random.randint(10, 255)) # цвет текста
pause_color = (0, 0, 255) # цвет кнопки пауза

# вычисление разрешения экрана
wight_screen = 0 # ширина экаран
height_screen = 0 # высота экаран
...
input_wight = int(input(f'ширина(50-{wight_screen - 110}):')) # введёная ширина
input_height = int(input(f'высота(50-{height_screen}):')) # введёная высота
input_flag = False # флаг на коректность введённых данных

# размеры поля
wight_field = 0 # ширина поля
height_field = 0 # высота поля

# проверка на коректность введёных данных
if (input_wight <= (wight_screen - 110)) and (input_height <= height_screen) and \
    ...
    print('Спасибо!')
    input_flag = True
    wight_field = input_wight
    height_field = input_height
else:
    while not input_flag:
        ...
        input_wight = int(input(f'ширина(50-{wight_screen - 110}):'))
        input_height = int(input(f'высота(50-{height_screen}):'))
        if (input_wight <= (wight_screen - 110)) and (input_height <= height_screen) and \
    ...
    if input_flag:
        ...
        while running:
            for event in pygame.event.get():
                ...
                if (x_mouse > wight_screen - 100) and (y_mouse > 300) and (y_mouse < 400):
                    mouse_in_break = (255, 0, 0)
                else:
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    elif (x_mouse > wight_screen - 100) and (y_mouse > 100) and (y_mouse < 200):
                        color = (random.randint(10, 255), random.randint(10, 255), random.randint(10, 255))

                    elif (x_mouse > wight_screen - 100) and (y_mouse > 300) and (y_mouse < 400):
                        running = False

                    elif (x_mouse > wight_screen - 100) and (y_mouse > 200) and (y_mouse < 300):
                        pygame.draw.polygon(screen, (0, 0, 0), ((x_1, y_1), (x_3, y_3), (x_2, y_2), (x_4, y_4)))
            screen = screen_2
            ...
            if pause_flag:
                if x < x_1 or x > x_2 or y < y_1 or y > y_2:
                    ...
                    print('Произошла техничская проблема, необходимо очистить поле')
            ...
            # границы поля
            pygame.draw.polygon(screen, (255, 255, 255), ((x_1 - 5, y_1 - 5), (x_3 - 5, y_3 + 5), (x_2 + 5, y_2 + 5), (x_4 + 5, y_4 - 5)), 10)
            ...
            pygame.draw.line(screen, background_color, (wight_screen - 100, 0), (wight_screen - 100, height_screen), 10)
            ...
            # создание кнопок
            # крест
            pygame.draw.line(screen, mouse_in_break, (wight_screen - 80, 320), (wight_screen - 20, 380), 10)
            pygame.draw.line(screen, mouse_in_break, (wight_screen - 20, 320), (wight_screen - 80, 380), 10)
            # пауза
            if not pause_flag:
                pygame.draw.line(screen, mouse_in_pause, (wight_screen - 70, 20), (wight_screen - 70, 80), 20)
                pygame.draw.line(screen, mouse_in_pause, (wight_screen - 30, 20), (wight_screen - 30, 80), 20)
            else:
                pygame.draw.line(screen, mouse_in_pause, (wight_screen - 70, 20), (wight_screen - 70, 80), 20)
                pygame.draw.line(screen, mouse_in_pause, (wight_screen - 30, 20), (wight_screen - 30, 80), 20)
            # смена цвета
