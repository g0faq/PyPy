...
if __name__ == '__main__':
    ...
    sound = pygame.mixer.Sound('for_dany.mp3')
    ...
    while running:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                running = False
            pic = pygame.image.load("dany.jpg")
            screen.blit(pygame.transform.scale(pic, (290, 150)), (wight_screen - 290, height_screen - 150))
            x_mouse = pygame.mouse.get_pos()[0]
            y_mouse = pygame.mouse.get_pos()[1]
            if (x_mouse > wight_screen - 290) and (y_mouse > height_screen - 150):
                pic = pygame.image.load("dany cool.jpg")
                screen.blit(pygame.transform.scale(pic, (290, 150)), (wight_screen - 290, height_screen - 150))
...
#        # кнопка старт
#        pygame.draw.rect(screen, (0, 255, 0), ((wight_screen - 290, height_screen - 150), (290, 150)))
...
#        screen.blit(text_start, (wight_screen - 230, height_screen - 100))
    ...
    while running_2:
        ...
        # границы поля
        pygame.draw.rect(screen_1, (255, 255, 255), ((x_1 - 5, y_1 - 5), ((x_2 - x_1) + 10, (y_2 - y_1) + 10)), 10)
